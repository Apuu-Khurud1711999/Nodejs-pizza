...
router.post("/addorder", (req, res) => {
    ...
    let transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
               user: 'khurudapurva@gmail.com',
               pass: 'AaPpUuRrVvAa99$'
           }
       });
    
    let mailOptions = {
        from: 'khurudapurva@gmail.com', // sender address
        to: 'angelkhurud@gmail.com', // list of receivers
        subject: 'Order Successfull !! ', // Subject line
        text: `<p>Your Order For Pizza is successfully placed. It will be dispatched soon!! </p> 
        Pizza : ${cart.map((cart)=>cart.name)}
        Total Amount : ${price}
        Card Number : ${card}`// plain text body
      };
